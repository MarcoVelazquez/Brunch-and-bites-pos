      ...
      <View style={styles.main}>
        ...
        <View style={styles.productsTable}>
          <View style={styles.tableHeader}>
            ...
            <Text style={[styles.tableCell, { flex: 2, fontWeight: "bold", fontSize: 22 }]}>Permisos</Text>
          ...
          <ScrollView>
            <View style={styles.tableRow}>
              <Text style={[styles.tableCell, { flex: 2 }]}>Admin</Text>
              <Text style={[styles.tableCell, { flex: 2 }]}>Todos</Text>
              <TouchableOpacity style={styles.editBtn}>
                <Text style={styles.editBtnText}>✏️</Text>
              </TouchableOpacity>
            </View>
            <View style={styles.tableRow}>
              <Text style={[styles.tableCell, { flex: 2 }]}>Cajero 1</Text>
              <Text style={[styles.tableCell, { flex: 2 }]}>Cobrar</Text>
              <TouchableOpacity style={styles.editBtn}>
                <Text style={styles.editBtnText}>✏️</Text>
              </TouchableOpacity>
            </View>
