        ...
        <View style={styles.productsTable}>
          ...
          <ScrollView>
            <View style={styles.tableRow}>
              <Text style={[styles.tableCell, { flex: 1.2 }]}>22/08/2025</Text>
              <Text style={[styles.tableCell, { flex: 1 }]}>50$</Text>
              <Text style={[styles.tableCell, { flex: 1.5 }]}>Traqueas</Text>
            </View>
            <View style={styles.tableRow}>
              <Text style={[styles.tableCell, { flex: 1.2 }]}>30/08/2025</Text>
              <Text style={[styles.tableCell, { flex: 1 }]}>30$</Text>
              <Text style={[styles.tableCell, { flex: 1.5 }]}>Orejas</Text>
            </View>
          </ScrollView>
        </View>
      </View>
